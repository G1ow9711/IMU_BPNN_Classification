...
本文定义仓库所交付的最终算法：右手腕六轴 IMU 数据合同、297 维特征、双 M0 分类、主动作确认、运动/休息门、实时计数、热量、资源约束和验证方法。
...
| [python/test_train_export.py](../python/test_train_export.py) | 特征、训练、导出和边界测试 |
| [python/test_dual_m0_export.py](../python/test_dual_m0_export.py) | Python/C 双 M0 一致性 |
| [python/test_visualize_action_features.py](../python/test_visualize_action_features.py) | 图表统计口径、输出名和清单测试 |
