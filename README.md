...
公开教程以 Markdown 为唯一文档来源。仓库不提交由 Markdown 生成的 PDF 副本，避免同一内容形成两套版本；`docs/ReferencePaper/` 中按 CC BY 4.0 发布的第三方论文是唯一例外。需要离线阅读教程时可在 GitHub 下载 Markdown，或由读者自行打印为 PDF。
